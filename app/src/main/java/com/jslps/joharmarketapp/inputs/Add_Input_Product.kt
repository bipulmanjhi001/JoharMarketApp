...
import com.jslps.joharmarketapp.inputs.Add_Input_Product
import java.io.ByteArrayOutputStream
import java.io.FileNotFoundException

class Add_Input_Product : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_add_input_product)
        Save = findViewById<View>(R.id.Save) as Button
        Save!!.setOnClickListener {
            val intent = Intent(this@Add_Input_Product, Input_Dealers::class.java)
            startActivity(intent)
        }
        photo = findViewById<View>(R.id.photo) as ImageView
        photo!!.setOnClickListener { selectImage(this@Add_Input_Product) }
    }
