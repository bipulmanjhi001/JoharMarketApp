package com.jslps.joharmarketapp.util;
...
public class MyJsonConverter extends Converter.Factory {
    ...
    final class GsonResponseBodyConverter<T> implements Converter<ResponseBody, T> {
        ...
        public T convert(ResponseBody value) throws IOException {
            ...
            String XmlString = dirty.substring(dirty.indexOf("\">") + 2);
            String result = XmlString.replaceAll("</string>", "");
           // String clean = dirty.replace("<?xmlversion=\"1.0\"encoding=\"utf-8\"?><stringxmlns=\"http://tempuri.org/\">", "").replace("</string>", "");
